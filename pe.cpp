...
ULONG PE::GetExportOffset(const unsigned char* FileData, ULONG FileSize, const char* ExportName)
{
    ...
    {
		DebugPrint("[DebugMessage] Invalid IMAGE_DOS_SIGNATURE!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
		DebugPrint("[DebugMessage] Invalid IMAGE_NT_SIGNATURE!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
		DebugPrint("[DebugMessage] Invalid Export Directory!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
		DebugPrint("[DebugMessage] Invalid Export Directory Contents!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
		DebugPrint("[DebugMessage] Export %s not found in export table!\r\n", ExportName);
    }
